...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument("--procs", type=int, default=1,
        ...
        self.add_argument("--frames", type=int, default=2560 * 140, # final study: 2560*180,  # default=int(9e10); actually the model is then trained on twice as much frames becasue we always say /self.num_frames_per_process 2...
        ...
        self.add_argument("--max-steps-mult", type=int, default=1, help="set a multiplicator for the max steps")
        self.add_argument("--until", type=float, default=-1, help="stops training at this success rate, if -1: no stop")
        self.add_argument("--store-results", type=str, default="general.csv",
                          help="file for storing data after training stops")
