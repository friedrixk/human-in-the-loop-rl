...
class Level_GoToRedSwitchGrey(RoomGridLevel):
    def __init__(self, room_size=8, num_dists=7, seed=None):
        self.num_dists = num_dists
        super().__init__(
            num_rows=1,
    ...
    def gen_mission(self):
        self.place_agent()
        obj, _ = self.add_object(0, 0, 'switch', 'red')
        dists = self.add_distractors(num_distractors=self.num_dists, all_unique=False)
...
"""class Level_UncoverGrey(RoomGridLevel):
    def __init__(self, room_size=8, num_dists=7, seed=None):
        self.num_dists = num_dists
        super().__init__(
            num_rows=1,
    ...
    def gen_mission(self):
        self.place_agent()
        obj, _ = self.add_object(0, 0, 'unspecified_door', 'red')
        dists = self.add_distractors(num_distractors=self.num_dists, all_unique=False)
        ...
        self.instrs = UncoverInstr(ObjDesc(obj.type, obj.color))"""


class Level_GoToRedSwitch(RoomGridLevel):
    def __init__(self, room_size=8, num_dists=7, seed=None):
        self.num_dists = num_dists
        super().__init__(
            num_rows=1,
...
class Level_Flip(RoomGridLevel):
    def __init__(self, room_size=8, num_dists=0, seed=None):
        self.num_dists = num_dists
        super().__init__(
            num_rows=1,
            num_cols=1,
    ...
    def gen_mission(self):
        ...
        self.check_objs_reachable()
        obj, _ = self.add_object(0, 0, 'switch')
        self.instrs = FlipInstr(ObjDesc(obj.type, obj.color))


class Level_FlipDist(RoomGridLevel):
    def __init__(self, room_size=8, num_dists=7, seed=None):
        self.num_dists = num_dists
        super().__init__(
            num_rows=1,
...
class Level_FlipBig(RoomGridLevel):
    def __init__(self, room_size=16, num_dists=7, seed=None):
        self.num_dists = num_dists
        super().__init__(
            num_rows=1,
            num_cols=1,
...
class Level_GoToOtherRoomOpen(RoomGridLevel):
    """
...
class Level_GoToOtherRoomClosed(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
...
class Level_GoToOtherRoomLocked(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
...
class Level_FlipInOtherRoomSwitch(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
    ...
    def gen_mission(self):
        # Add a random object to the room on the right
        obj, _ = self.add_object(1, 0, kind="switch")

        dists = self.add_distractors(num_distractors=self.num_dists, all_unique=False, no_switches=True)
        # Make sure the two rooms are directly connected by a locked door
        door, _ = self.add_door(0, 0, 0, locked=True)

        self.add_object(0, 0, 'switch', door.color)
...
class Level_FlipRoom(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
...
class Level_PickUpOtherRoom(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
...
class Level_UncoverUnspecifiedDoor(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
    ...
    def gen_mission(self):
        ...
        dists = self.add_distractors(num_distractors=self.num_dists, all_unique=False)
        # Make sure the two rooms are directly connected by a locked door
        door, _ = self.add_door(0, 0, 0, locked=True, unspecified=True)
        # Add a key to unlock the door
        self.add_object(0, 0, 'key', door.color)

        self.place_agent(0, 0)

        self.instrs = UncoverInstr(ObjDesc(door.type, door.color))

class Level_GoToUnspecifiedRoom(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
...
class Level_BlockedRoomBall(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
...
class Level_OpenMoveBox(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
    ...
    def gen_mission(self):
        ...
        dists = self.add_distractors(i=1, j=0, num_distractors=self.num_dists, all_unique=False) #i=1, j=0,
        # Make sure the two rooms are directly connected by a locked door
        door, pos = self.add_door(0, 0, 0, locked=False, movable_blocked=True)

        self.place_agent(0, 0)

        self.instrs = OpenInstr(ObjDesc(door.type, door.color))

class Level_BlockedRoomMovBox(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
    ...
    def gen_mission(self):
        ...
        dists = self.add_distractors(i=1, j=0, num_distractors=self.num_dists, all_unique=False)
        # Make sure the two rooms are directly connected by a locked door
        door, pos = self.add_door(0, 0, 0, locked=True, movable_blocked=True)
...
class Level_BlockedRoomUnspecified(RoomGridLevel):
    """
    Unlock a door blocked by a ball, then pick up a box
    in another room
    """
    ...
    def gen_mission(self):
        ...
        dists = self.add_distractors(num_distractors=self.num_dists, all_unique=False)
        # Make sure the two rooms are directly connected by a locked door
        door, pos = self.add_door(0, 0, 0, locked=True, unspecified=True, movable_blocked=True)
...
class Level_UnlockSwitch(RoomGridLevel):
    """
    Unlock a door.
    ...
    def gen_mission(self):
        ...
        while True:
            ...
            if ik is id and jk is jd:
                continue
            self.add_object(ik, jk, 'switch', door.color)
            break
