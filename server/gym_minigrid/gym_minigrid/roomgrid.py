...
class RoomGrid(MiniGridEnv):
    ...
    def add_door(self, i, j, door_idx=None, color=None, locked=None, unspecified=False, movable_blocked=False, opened=False):
        """
    ...
    def add_distractors(self, i=None, j=None, num_distractors=10, all_unique=True, no_switches=False):
        """
