from gym_minigrid.minigrid import Grid, Floor, Goal, MiniGridEnv, Door, Switch, UnspecifiedDoor2
...
class UnspecifiedDoor(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        self.place_obj(
            obj=Switch('purple', True),
            top=(splitIdx - 1, doorIdx - 1),
            size=(1, 1)
        )
        self.place_obj(
            obj=Switch('yellow', True),
            top=(1, 1),
            size=(1, 1)
        )
